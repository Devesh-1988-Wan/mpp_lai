...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-primary/10 via-background to-secondary/10 flex-grow">
        <div className="container mx-auto px-6 py-24 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
            Project Management
            <span className="block" style={{ color: '#5db043' }}>Made Simple</span>
          </h1>
          ...
          {user ? (
            <div className="flex gap-4 justify-center">
              <Button size="lg" onClick={() => navigate('/projects')} variant="primary">
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <BarChart3 className="w-5 h-5" style={{ color: '#5db043' }} />
                Gantt Charts
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Users className="w-5 h-5" style={{ color: '#5db043' }} />
                Team Collaboration
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Plus className="w-5 h-5" style={{ color: '#5db043' }} />
                Custom Fields
              </CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <footer className="bg-header-background text-header-foreground py-4 mt-auto">
        <div className="container mx-auto text-center">
          <p>Designed by Znode Pro</p>
        </div>
      </footer>
    </div>
  );
