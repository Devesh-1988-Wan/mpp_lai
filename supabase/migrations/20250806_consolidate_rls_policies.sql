-- Drop all potentially conflicting policies on related tables to ensure a clean slate.
DO $$
DECLARE
    r RECORD;
BEGIN
...
-- === TASKS TABLE POLICIES (REWRITTEN TO AVOID RECURSION) ===
...
-- === CUSTOM FIELDS TABLE POLICIES (REWRITTEN TO AVOID RECURSION) ===
